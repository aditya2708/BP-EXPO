...
const RaportScreen = () => {
  ...
  const fetchRaportData = async () => {
    ...
    try {
      setError(null);
      const response = await adminPusatAnakApi.getRaports(anakId);
  ...
  const handleViewRaport = (raport) => {
    navigation.navigate('RaportDetail', {
      anakData,
      anakId,
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.sectionHeader}>
          ...
          <Text style={styles.sectionSubtitle}>
            Total {summary.total_raport || 0} raport, {summary.semester_count || 0} semester
          </Text>
        </View>
