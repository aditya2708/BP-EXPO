      ...
      <View style={styles.infoSection}>
        ...
        {anakData?.shelter && (
          <>
            ...
            {anakData.shelter.wilbin && (
              <View style={styles.infoRow}>
                <View style={styles.infoLabel}>
                  <Ionicons name="navigate-outline" size={20} color="#666" />
                  <Text style={styles.infoLabelText}>Wilayah Binaan</Text>
                </View>
                <Text style={styles.infoValue}>{anakData.shelter.wilbin.nama_wilbin || '-'}</Text>
              </View>
            )}
            
            {anakData.shelter.wilbin && anakData.shelter.wilbin.kacab && (
              <View style={styles.infoRow}>
                <View style={styles.infoLabel}>
                  <Ionicons name="business-outline" size={20} color="#666" />
                  <Text style={styles.infoLabelText}>Cabang</Text>
                </View>
                <Text style={styles.infoValue}>{anakData.shelter.wilbin.kacab.nama_cabang || '-'}</Text>
              </View>
            )}
          </>
        )}
