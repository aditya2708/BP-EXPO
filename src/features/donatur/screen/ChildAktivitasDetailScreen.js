    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.header}>
        <View style={styles.headerTop}>
          ...
          <View style={[
            ...
            { backgroundColor: getAttendanceColor(aktivitas.attendance_status) }
          ]}>
            <Ionicons 
              name={getAttendanceIcon(aktivitas.attendance_status)} 
              size={20} 
              color="#ffffff" 
            />
          </View>
        ...
        <View style={styles.timeGrid}>
          ...
          {aktivitas.late_threshold && (
            <View style={styles.timeItem}>
              ...
              <Text style={styles.timeLabel}>Late After</Text>
        ...
        <View style={styles.attendanceCard}>
          <View style={styles.attendanceHeader}>
            ...
            <Text style={[
              ...
              { color: getAttendanceColor(aktivitas.attendance_status) }
            ]}>
            ...
            <View style={styles.attendanceDetail}>
              ...
              <View style={styles.verificationStatus}>
                <Text style={[
                  ...
                  {aktivitas.attendance_verified ? 'Verified' : 'Pending'}
                </Text>
                <Ionicons 
      ...
      {(aktivitas.foto_1_url || aktivitas.foto_2_url || aktivitas.foto_3_url) && (
        <View style={styles.photosContainer}>
          ...
          >
            {aktivitas.foto_1_url && (
              <TouchableOpacity style={styles.photoWrapper}>
                <Image
                  source={{ uri: aktivitas.foto_1_url }}
            ...
            {aktivitas.foto_2_url && (
              <TouchableOpacity style={styles.photoWrapper}>
                <Image
                  source={{ uri: aktivitas.foto_2_url }}
                  style={styles.activityPhoto}
                  resizeMode="cover"
                />
              </TouchableOpacity>
            ...
            {aktivitas.foto_3_url && (
              <TouchableOpacity style={styles.photoWrapper}>
                <Image
                  source={{ uri: aktivitas.foto_3_url }}
                  style={styles.activityPhoto}
                  resizeMode="cover"
                />
              </TouchableOpacity>
          ...
          <View style={styles.materialCard}>
            <View style={styles.materialHeader}>
              ...
              <Text style={styles.materialSubject}>
                {aktivitas.materi_data.mata_pelajaran}
              </Text>
            </View>
            
            <Text style={styles.materialName}>
              {aktivitas.materi_data.nama_materi}
            </Text>
            
            {aktivitas.materi_data.level_anak_binaan && (
              <Text style={styles.materialLevel}>
                Level: {aktivitas.materi_data.level_anak_binaan.nama_level}
              </Text>
            )}
          </View>
        </View>
