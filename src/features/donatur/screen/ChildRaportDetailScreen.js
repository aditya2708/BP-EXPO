...
const ChildRaportDetailScreen = () => {
  ...
  if (loading) {
    return <LoadingSpinner fullScreen message="Loading report card..." />;
  }
  ...
  if (error || !raport) {
    return (
      <View style={styles.container}>
        <ErrorMessage
          message={error || "Report card not found"}
          onRetry={fetchRaportDetail}
        />
      </View>
    );
  }
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.header}>
        <Text style={styles.semesterTitle}>
          {raport.semester?.nama_semester || 'Semester Report'}
        </Text>
        <Text style={styles.tahunAjaran}>
          {raport.semester?.tahun_ajaran || ''}
        </Text>
      ...
      <View style={styles.summaryContainer}>
        ...
        <View style={styles.statsGrid}>
          ...
          <View style={styles.statCard}>
            ...
            <Text style={styles.statLabel}>Class Ranking</Text>
          </View>
          
          <View style={styles.statCard}>
            <Ionicons name="people" size={24} color="#2ecc71" />
            <Text style={styles.statNumber}>
              {raport.total_kehadiran || 0}
            </Text>
          ...
          {raport.raport_detail.map((subject, index) => (
            <View key={index} style={styles.subjectCard}>
              <View style={styles.subjectHeader}>
                ...
                <View style={[
                  styles.subjectGrade,
                  { backgroundColor: getGradeColor(subject.nilai_akhir) }
                ]}>
              ...
              <View style={styles.subjectDetails}>
                ...
                <View style={styles.subjectDetail}>
                  ...
                  <Text style={[
                    ...
                    {subject.keterangan || (subject.nilai_akhir >= (subject.kkm || 70) ? 'Passed' : 'Failed')}
                  </Text>
                </View>
              </View>
            </View>
        ...
        <View style={styles.infoGrid}>
          ...
          <View style={styles.infoItem}>
            ...
            <Text style={[styles.infoValue, { color: '#2ecc71' }]}>
              {raport.status === 'published' ? 'Published' : raport.status}
            </Text>
          </View>
        </View>
      </View>
