...
const ChildRaportListScreen = () => {
  ...
  const handleViewRaport = (raportId) => {
    navigation.navigate('ChildRaportDetail', { 
      childId, 
      raportId, 
      childName
    });
  ...
  const renderRaportItem = ({ item }) => {
    ...
    return (
      <TouchableOpacity 
        ...
        onPress={() => handleViewRaport(item.id_raport)}
      >
        ...
        <View style={styles.cardContent}>
          ...
          <View style={styles.cardFooter}>
            <Text style={styles.publishDate}>
              Published: {formatDate(item.tanggal_terbit)}
            </Text>
  ...
  if (loading && !refreshing) {
    return <LoadingSpinner fullScreen message="Loading report cards..." />;
  }
    ...
    <View style={styles.container}>
      ...
      {raportList.length > 0 ? (
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>No report cards yet</Text>
          <Text style={styles.emptySubText}>
            {childName}'s academic reports will appear here when available
          </Text>
        </View>
      )}
    </View>
