...
export const ENTITY_CONFIGS = {
  [ENTITY_TYPES.JENJANG]: {
    ...
    fields: {
      id: { type: FIELD_TYPES.NUMBER, readonly: true },
      nama: { 
    ...
    validation: {
      ...
      kode: [
        { rule: 'required', message: 'Kode jenjang wajib diisi' },
        { rule: 'minLength', value: 1, message: 'Kode minimal 1 karakter' },
    ...
    ui: {
      ...
      listEmptySubtext: 'Mulai dengan menambahkan jenjang pendidikan'
    },
    api: {
      nameField: 'nama',
      idField: 'id'
  ...
  [ENTITY_TYPES.MATA_PELAJARAN]: {
    ...
    ui: {
      ...
      listEmptySubtext: 'Mulai dengan menambahkan mata pelajaran'
    },
    api: {
      nameField: 'nama_mata_pelajaran',
      idField: 'id_mata_pelajaran'
    },
    search: {
      placeholder: 'Cari mata pelajaran...',
      fields: ['nama_mata_pelajaran', 'kode_mata_pelajaran', 'kategori']
    }
  },
  ...
  [ENTITY_TYPES.KELAS]: {
    ...
    ui: {
      ...
      listEmptySubtext: 'Mulai dengan menambahkan kelas'
    },
    api: {
      nameField: 'nama_kelas',
      idField: 'id_kelas'
    },
    search: {
      placeholder: 'Cari kelas...',
      fields: ['nama_kelas', 'tingkat', 'jenis_kelas']
    }
  },
  ...
  [ENTITY_TYPES.MATERI]: {
    ...
    ui: {
      ...
      listEmptySubtext: 'Mulai dengan menambahkan materi pembelajaran'
    },
    api: {
      nameField: 'nama_materi',
      idField: 'id_materi'
    },
    search: {
      placeholder: 'Cari materi...',
      fields: ['nama_materi', 'kode_materi', 'tingkat_kesulitan']
    }
  },
  ...
  [ENTITY_TYPES.KURIKULUM]: {
    ...
    ui: {
      ...
      listEmptySubtext: 'Mulai dengan menambahkan kurikulum',
      specialActions: ['assign-materi']
    },
    api: {
      nameField: 'nama_kurikulum',
      idField: 'id_kurikulum'
    },
    search: {
      placeholder: 'Cari kurikulum...',
      fields: ['nama_kurikulum', 'tahun_berlaku', 'status']
    }
  },
};
