...
const createEntityThunks = (entityType) => {
  ...
  const fetchAll = createAsyncThunk(
    ...
    async (params = {}, { rejectWithValue }) => {
      try {
        const response = await apiClient.get(config.api.endpoints.list, { params });
        return {
  ...
  const fetchById = createAsyncThunk(
    ...
    async ({ id }, { rejectWithValue }) => {
      try {
        const response = await apiClient.get(config.api.endpoints.detail(id));
  ...
  const create = createAsyncThunk(
    ...
    async (data, { rejectWithValue }) => {
      try {
        const response = await apiClient.post(config.api.endpoints.create, data);
        return response.data.data || response.data;
      } catch (error) {
        return rejectWithValue({
  ...
  const update = createAsyncThunk(
    ...
    async ({ id, data }, { rejectWithValue }) => {
      try {
        const response = await apiClient.put(config.api.endpoints.update(id), data);
        return response.data.data || response.data;
      } catch (error) {
        return rejectWithValue({
  ...
  const remove = createAsyncThunk(
    ...
    async ({ id }, { rejectWithValue }) => {
      try {
        await apiClient.delete(config.api.endpoints.delete(id));
        return { id };
      } catch (error) {
        return rejectWithValue({
...
export const kurikulumThunks = {
  ...
  setActive: createAsyncThunk(
    ...
    async ({ id }, { rejectWithValue }) => {
      try {
        ...
        const response = await apiClient.post(config.api.endpoints.setActive(id));
        return response.data.data || response.data;
      } catch (error) {
        return rejectWithValue({
  ...
  addMateri: createAsyncThunk(
    ...
    async ({ id, materiIds }, { rejectWithValue }) => {
      try {
        const config = getEntityConfig(ENTITY_TYPES.KURIKULUM);
        const response = await apiClient.post(config.api.endpoints.addMateri(id), {
  ...
  removeMateri: createAsyncThunk(
    ...
    async ({ id, materiId }, { rejectWithValue }) => {
      try {
        const config = getEntityConfig(ENTITY_TYPES.KURIKULUM);
        await apiClient.delete(config.api.endpoints.removeMateri(id, materiId));
...
export const optionsThunks = {
  loadJenjangOptions: createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
      try {
        ...
        const response = await apiClient.get(config.api.endpoints.list);
        return response.data.data || response.data;
      } catch (error) {
        return rejectWithValue({
  ...
  loadKategoriOptions: createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
      try {
        const config = getEntityConfig(ENTITY_TYPES.MATA_PELAJARAN);
        const response = await apiClient.get(config.api.endpoints.categories);
        return response.data.data || response.data;
      } catch (error) {
        return rejectWithValue({
