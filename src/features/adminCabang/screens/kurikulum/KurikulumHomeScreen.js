...
import { useGetKurikulumStatisticsQuery } from '../../api/kurikulumApi';
  ...
  const handleMenuPress = (menuType) => {
    switch (menuType) {
      ...
      case 'semester':
        ...
        break;
      case 'master_data':
        Alert.alert('Info', 'Fitur Master Data akan segera hadir di Sprint 2');
        break;
      default:
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.menuContainer}>
        ...
        >
          ...
          <View style={styles.menuContent}>
            <Text style={[styles.menuTitle, styles.comingSoonText]}>Master Data</Text>
            <Text style={[styles.menuDescription, styles.comingSoonText]}>
              Kelola kelas custom & mata pelajaran custom (Segera Hadir)
            </Text>
          </View>
          <Ionicons name="chevron-forward" size={20} color="#ccc" />
        </TouchableOpacity>
