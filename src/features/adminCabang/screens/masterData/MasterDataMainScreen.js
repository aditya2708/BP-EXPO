...
const MasterDataMainScreen = () => {
  ...
  const menuItems = [
    ...
    },
    {
      id: 'kelas',
      title: 'Kelas',
      description: 'Kelola data kelas (standard & custom)',
      icon: 'people-outline',
      color: '#28a745',
      route: 'KelasList',
      available: true
          ...
          <View style={styles.progressCard}>
            ...
            <View style={styles.progressItems}>
              <View style={styles.progressItem}>
                ...
                <Text style={styles.progressItemText}>Jenjang ✓</Text>
              </View>
              <View style={styles.progressItem}>
                <View style={[styles.progressDot, { backgroundColor: '#28a745' }]} />
                <Text style={styles.progressItemText}>Mata Pelajaran ✓</Text>
              </View>
              <View style={styles.progressItem}>
                <View style={[styles.progressDot, { backgroundColor: '#28a745' }]} />
                <Text style={styles.progressItemText}>Kelas ✓</Text>
              </View>
              <View style={styles.progressItem}>
                <View style={[styles.progressDot, { backgroundColor: '#ffc107' }]} />
                <Text style={styles.progressItemText}>Materi (Coming Soon)</Text>
              </View>
            </View>
          </View>
        </View>
