      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.info}>
          ...
          <View style={styles.hierarchyCard}>
            <Text style={styles.hierarchyTitle}>Hierarki Data</Text>
            <View style={styles.hierarchyFlow}>
              <Text style={styles.hierarchyItem}>Jenjang</Text>
              <Ionicons name="arrow-forward" size={16} color="#666" />
              <Text style={styles.hierarchyItem}>Mata Pelajaran</Text>
              <Ionicons name="arrow-forward" size={16} color="#666" />
              <Text style={styles.hierarchyItem}>Kelas</Text>
              <Ionicons name="arrow-forward" size={16} color="#666" />
              <Text style={styles.hierarchyItem}>Materi</Text>
            </View>
          </View>
        </View>
      </ScrollView>
