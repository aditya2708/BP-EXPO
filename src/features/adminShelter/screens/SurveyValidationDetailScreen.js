...
const SurveyValidationDetailScreen = () => {
  ...
  return (
    ...
    >
      ...
      {/* Validation Form */}
      <View style={styles.card}>
        <Text style={styles.cardTitle}>Validate Survey</Text>
        
        <View style={styles.validationForm}>
          <Text style={styles.validationLabel}>Validation Result *</Text>
          ...
          <Text style={styles.validationLabel}>Notes</Text>
          <TextInput
            value={validationNotes}
            onChangeText={setValidationNotes}
            placeholder="Enter notes for this validation result"
            multiline
