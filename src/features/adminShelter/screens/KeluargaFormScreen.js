...
const KeluargaFormScreen = () => {
  ...
  useEffect(() => {
    navigation.setOptions({
      headerTitle: isEditMode ? 'Edit Family' : 'Add New Family'
    });
    ...
    >
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <Text style={styles.stepTitle}>
          {currentStep === STEPS.FAMILY && 'Family Information'}
          {currentStep === STEPS.PARENTS && 'Parents Information'}
          {currentStep === STEPS.GUARDIAN && 'Guardian Information'}
          {currentStep === STEPS.CHILD && 'Child Information'}
          {currentStep === STEPS.EDUCATION && 'Education Information'}
