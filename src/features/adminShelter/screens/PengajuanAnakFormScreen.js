...
const PengajuanAnakFormScreen = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    jenjang: '', kelas: '', nama_sekolah: '', alamat_sekolah: '', jurusan: '', 
    semester: '', nama_pt: '', alamat_pt: '', nik_anak: '', anak_ke: '', 
    dari_bersaudara: '', nick_name: '', full_name: '', agama: '', tempat_lahir: '', 
    tanggal_lahir: '', jenis_kelamin: '', tinggal_bersama: '', jenis_anak_binaan: '', 
    hafalan: '', pelajaran_favorit: '', hobi: '', prestasi: '', jarak_rumah: '', 
    transportasi: '', foto: null,
  });
    ...
    >
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.section}>
          ...
          {renderPicker('Jenis Binaan', formData.jenis_anak_binaan, options.childType, 'jenis_anak_binaan', true)}
