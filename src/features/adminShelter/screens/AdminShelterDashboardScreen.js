// Update the AdminShelterDashboardScreen.js
...
const AdminShelterDashboardScreen = () => {
  ...
  const navigateToKeluargaManagement = () => navigation.navigate('Management', { screen: 'KeluargaManagement' });
   const navigateToSurveyManagement = () => navigation.navigate('Management', { screen: 'SurveyManagement' });
  ...
  return (
    ...
    >
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.title}>Admin Shelter Dashboard</Text>
      </View>
...
>
  ...
  <Text style={styles.menuText}>Family Management</Text>
</TouchableOpacity>
        <TouchableOpacity 
          style={styles.menuItem}
        ...
        >
          ...
          <Text style={styles.menuText}>Children Management</Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={styles.menuText}>Kelompok Management</Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={styles.menuText}>Tutor Management</Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={styles.menuText}>Family Survey</Text>
        </TouchableOpacity>
