...
const AdminShelterDashboardScreen = () => {
  ...
  const navigateToCameraTest = () => navigation.navigate('TestExpoCameraScreen'); // Make sure this matches the screen name exactly
    ...
    >
      ...
      <View style={styles.menuContainer}>
        ...
        >
          ...
          <Text style={styles.menuText}>Survei</Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={styles.menuText}>Camera Test</Text>
        </TouchableOpacity>
