    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <View style={styles.emptyStateContainer}>
          ...
          <Text style={styles.emptyStateTitle}>Hallo Rapor Shelter</Text>
          <Text style={styles.emptyStateText}>
            Fitur rapor shelter akan segera tersedia. Saat ini kami sedang menyiapkan sistem evaluasi shelter untuk meningkatkan kualitas layanan.
          </Text>
        </View>
      </View>
    </ScrollView>
