    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <View style={styles.emptyStateContainer}>
          ...
          <Text style={styles.emptyStateTitle}>Hallo Prestasi</Text>
          <Text style={styles.emptyStateText}>
            Fitur prestasi akan segera tersedia. Saat ini kami sedang menyiapkan data prestasi yang diraih oleh anak.
          </Text>
        </View>
      </View>
    </ScrollView>
