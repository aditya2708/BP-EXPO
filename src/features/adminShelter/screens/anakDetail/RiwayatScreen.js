    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <View style={styles.emptyStateContainer}>
          ...
          <Text style={styles.emptyStateTitle}>Hallo Riwayat</Text>
          <Text style={styles.emptyStateText}>
            Fitur riwayat akan segera tersedia. Saat ini kami sedang menyiapkan data riwayat anak, termasuk kesehatan dan pencapaian.
          </Text>
        </View>
      </View>
    </ScrollView>
