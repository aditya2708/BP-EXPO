...
const SurveyManagementScreen = () => {
  ...
  // State
  const [activeTab, setActiveTab] = useState('survey'); // 'survey' or 'validation'
  ...
  useEffect(() => {
    if (activeTab === 'survey') {
      ...
      // Reset loading state for validation tab
      setLoading(false);
    }
  }, [activeTab]);
    ...
    return (
      <View style={styles.tabContainer}>
        <TouchableOpacity
          style={[
            styles.tabButton,
            activeTab === 'survey' && styles.activeTabButton
          ]}
        ...
        >
          <Ionicons 
            ...
            size={18} 
            color={activeTab === 'survey' ? '#fff' : '#e74c3c'} 
            style={styles.tabIcon}
          />
          <Text style={[
            styles.tabText,
            activeTab === 'survey' && styles.activeTabText
          ]}>
            Survey Family
          </Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          style={[
            styles.tabButton,
            activeTab === 'validation' && styles.activeTabButton
          ]}
        ...
        >
          <Ionicons 
            ...
            size={18} 
            color={activeTab === 'validation' ? '#fff' : '#e74c3c'} 
            style={styles.tabIcon}
          />
          <Text style={[
            styles.tabText,
  ...
  // Render content for survey validation tab
  const renderValidationTab = () => {
    return (
      <View style={styles.validationContainer}>
        <Ionicons name="hammer-outline" size={60} color="#e74c3c" />
        <Text style={styles.validationTitle}>Hello, this is the survey validation menu</Text>
        <Text style={styles.validationText}>This feature is currently under development.</Text>
      </View>
    );
  };

  // Render survey family tab content
  const renderSurveyTab = () => {
    // Loading state
    if (loading && !refreshing && !loadingMore) {
      return <LoadingSpinner fullScreen={false} message="Loading families..." />;
    }
  ...
  return (
    <View style={styles.container}>
      ...
      {activeTab === 'survey' ? renderSurveyTab() : renderValidationTab()}
    </View>
  );
};
