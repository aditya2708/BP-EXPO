  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Add Child to Existing Family</Text>
        <Text style={styles.subtitle}>
          Search for a family by KK number or create a new family
        </Text>
      </View>
      ...
      {searching ? (
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>No families found with this KK number</Text>
          <Button
