...
const SurveyValidationManagementScreen = () => {
    ...
    return (
      <View style={styles.summaryContainer}>
        <View style={styles.summaryTitle}>
          ...
          <Text style={styles.summaryTitleText}>Validation Summary</Text>
        </View>
        ...
        <View style={styles.summaryCards}>
          ...
          <View style={[styles.summaryCard, { backgroundColor: '#2ecc71' }]}>
            ...
            <Text style={[styles.summaryLabel, { color: '#fff' }]}>Eligible</Text>
          </View>
          ...
          <View style={[styles.summaryCard, { backgroundColor: '#e74c3c' }]}>
            ...
            <Text style={[styles.summaryLabel, { color: '#fff' }]}>Not Eligible</Text>
          </View>
        </View>
      </View>
    );
  ...
  if (loading && !refreshing) {
    return <LoadingSpinner fullScreen={false} message="Loading surveys..." />;
  }
        ...
        <FlatList
          ...
          ListHeaderComponent={
            <Text style={styles.listHeader}>
              Pending Surveys ({validationList.length})
            </Text>
          }
        />
      ) : (
