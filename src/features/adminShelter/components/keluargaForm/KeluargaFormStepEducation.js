...
const KeluargaFormStepEducation = ({
  ...
  const renderSchoolFields = () => (
    <>
      {renderPicker('Kelas', formData.kelas, getGradeOptions(formData.jenjang), 'kelas')}
      
      {formData.jenjang === 'sma' && 
        renderPicker('Jurusan', formData.jurusan, SMA_MAJOR_OPTIONS, 'jurusan')
      }
  ...
  const renderCollegeFields = () => (
    <>
      {renderPicker('Semester', formData.semester, SEMESTER_OPTIONS, 'semester')}
