    ...
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        >
          ...
          <Text style={styles.dateText}>
            {formData.tanggal_lahir_ayah || 'Select date of birth'}
          </Text>
        </TouchableOpacity>
      ...
      <View style={styles.inputContainer}>
        ...
        >
          <Ionicons name="calendar-outline" size={20} color="#777" style={styles.dateIcon} />
          <Text style={styles.dateText}>
            {formData.tanggal_kematian_ayah || 'Select date of death'}
          </Text>
        </TouchableOpacity>
      ...
      <TextInput
        ...
        placeholder="Enter mother's place of birth"
        leftIcon={<Ionicons name="location-outline" size={20} color="#777" />}
      />
      ...
      <View style={styles.inputContainer}>
        ...
        >
          <Ionicons name="calendar-outline" size={20} color="#777" style={styles.dateIcon} />
          <Text style={styles.dateText}>
            {formData.tanggal_lahir_ibu || 'Select date of birth'}
          </Text>
        </TouchableOpacity>
      ...
      <View style={styles.inputContainer}>
        ...
        >
          <Ionicons name="calendar-outline" size={20} color="#777" style={styles.dateIcon} />
          <Text style={styles.dateText}>
            {formData.tanggal_kematian_ibu || 'Select date of death'}
          </Text>
        </TouchableOpacity>
