...
const AttendanceCard = ({ 
  ...
  const getAttendanceStatusText = () => {
    if (absen === 'Ya') return 'Present';
    if (absen === 'Terlambat') return 'Late';
    return 'Absent';
  };
    ...
    >
      ...
      {aktivitas && (
        <View style={styles.activityInfo}>
          ...
          {/* Show arrival time if late or present */}
          {time_arrived && (absen === 'Terlambat' || absen === 'Ya') && (
            <Text style={[styles.arrivalTime, absen === 'Terlambat' ? styles.lateArrival : null]}>
