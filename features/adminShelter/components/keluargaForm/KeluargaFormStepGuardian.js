  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
        ...
        placeholder="Enter guardian's NIK"
      ...
      <View style={styles.inputContainer}>
        <Text style={styles.label}>Relation to Child</Text>
      ...
      <TextInput
        ...
        placeholder="Enter guardian's place of birth"
      ...
      <View style={styles.inputContainer}>
        ...
        >
          ...
          <Text style={styles.dateText}>
            {formData.tanggal_lahir_wali || 'Select date of birth'}
          </Text>
        </TouchableOpacity>
