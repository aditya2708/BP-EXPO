...
const KelompokFormScreen = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.nama_kelompok.trim()) {
      errors.nama_kelompok = 'Group name is required';
    }
    
    if (!formData.id_level_anak_binaan) {
      errors.id_level_anak_binaan = 'Please select a level';
    }
    ...
    >
      ...
      >
        ...
        {isEditMode && (
          <View style={styles.formGroup}>
            ...
            <Text style={styles.helperText}>
              This value is updated automatically when children are added or removed
            </Text>
          </View>
        )}
        ...
        <View style={styles.actionButtons}>
          ...
          <Button
            title={isEditMode ? "Save Changes" : "Create Group"}
